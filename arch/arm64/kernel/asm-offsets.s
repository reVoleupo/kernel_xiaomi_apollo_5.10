...
.ascii "->THREAD_CPU_CONTEXT 2544 offsetof(struct task_struct, thread.cpu_context)"
	//NO_APP
	//APP
	
.ascii "->THREAD_SCTLR_USER 3512 offsetof(struct task_struct, thread.sctlr_user)"
	//NO_APP
	//APP

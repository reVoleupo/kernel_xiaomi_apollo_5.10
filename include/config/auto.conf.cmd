...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/home/user/apollo-kernel/toolchains/proton-clang/bin/aarch64-linux-gnu- --gcc-toolchain=/home/user/apollo-kernel/toolchains/proton-clang -fno-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
